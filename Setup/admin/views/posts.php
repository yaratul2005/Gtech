...
<div style="margin-bottom: 30px;" class="flex-between">
    ...
    <a href="/admin/posts?action=write" class="btn btn-primary" style="background: linear-gradient(135deg, #10b981 0%, #059669 100%); border-color: #10b981; display: inline-flex; align-items: center; gap: 8px; text-decoration: none; height: 38px; line-height: 20px;">
            ...
            <?php foreach ($posts as $p): ?>
                <div class="flex-between" id="post-row-<?php echo htmlspecialchars($p['slug']); ?>" 
                    ...
                    <div style="display: flex; gap: 8px;">
                        <a href="/admin/posts?action=write&slug=<?php echo htmlspecialchars($p['slug']); ?>" class="btn btn-secondary btn-sm" 
